...
# Project:C:\tmp\mp2ya\system\system.xmp
#
...
PROJECT_SEARCHPATHOPT =  -lp C:/tmp/mp2ya/repository/
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(XPS_HDL_LANG) -intstyle $(INTSTYLE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_SIM_FILE_ARGS) -msg __xps/ise/xmsgprops.lst -s isim -X C:/tmp/mp2ya/system/
